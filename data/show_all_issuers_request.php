...
$requests = $request->all_issuers_request();
...
<br />
<table id="myTable-issuers-request" class="table table-bordered table-hover" cellspacing="0" width="100%">
	<thead>
	    <tr>
	        <th>Item Name</th>
	        <th>Request Date</th>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#myTable-issuers-request').DataTable();
	});
</script>
