...
CREATE TABLE `tbl_user` (
  ...
  `usr_mname` varchar(100) NOT NULL,
  `usr_lname` varchar(100) NOT NULL,
  `pos_id` int(11) NOT NULL,
  `dep_id` int(11) NOT NULL,
  `usr_un` varchar(100) NOT NULL,
  `usr_pass` varchar(40) NOT NULL,
  `type_id` int(11) NOT NULL,
  `usr_at_nuemgt` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_user` (`usr_id`, `usr_fname`, `usr_mname`, `usr_lname`, `pos_id`, `dep_id`, `usr_un`, `usr_pass`, `type_id`, `usr_at_nuemgt`) VALUES
(37, 'Pranjali', 'Vilas', 'Dumbre', 1, 1, 'Pranjali', 'ee11cbb19052e40b07aac0ca060c23ee', 1, 1),
(38, 'Govind', 'Rajendra', 'Chaurasiya', 2, 2, 'Govind', '24c9e15e52afc47c225b757e7bee1f9d', 1, 1),
(39, 'Akshada', ' ', 'Kulkarni', 1, 1, 'Akshada', '86cd607ba94a7dc9bb3a0baf1d4c1926', 1, 1),
(40, 'Antarlina', ' ', 'Paul', 2, 2, 'Antarlina', 'c87cac2c4079f860c8e0c8075ba4ae33', 1, 0),
(43, 'Mayank', ' ', 'Gupta', 1, 1, 'Mayank', '65ac1cb0d396486f1d2bae5310bddb67', 1, 0),
(44, 'Piyush', 'Vijay', 'Mishra', 2, 2, 'Piyush', '2c346f9df8cba24a0f2e985374ec2cd9', 1, 0),
(48, 'NIIT', ' ', 'Admin', 1, 1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 2, 1);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_usr_type`
--

CREATE TABLE `tbl_usr_type` (
  `type_id` int(11) NOT NULL,
  `type_desc` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_usr_type`
--

INSERT INTO `tbl_usr_type` (`type_id`, `type_desc`) VALUES
(1, 'User'),
(2, 'Admin');
...
INSERT INTO `tbl_item` (`item_id`, `item_name`, `item_serno`, `item_modno`, `item_brand`, `item_amount`, `item_purdate`, `usr_id`, `cat_id`, `con_id`, `status_id`) VALUES
...
INSERT INTO `tbl_dep` (`dep_id`, `dep_desc`) VALUES
(1, 'PERSONNEL'),
(2, 'SGOD'),
(8, 'AAA');
...
--
-- Indexes for table `tbl_usr_type`
--
ALTER TABLE `tbl_usr_type`
...
--
-- AUTO_INCREMENT for table `tbl_usr_type`
--
ALTER TABLE `tbl_usr_type`
...
--
ALTER TABLE `tbl_user`
  ADD CONSTRAINT `tbl_user_ibfk_1` FOREIGN KEY (`type_id`) REFERENCES `tbl_usr_type` (`type_id`),
  ADD CONSTRAINT `tbl_user_ibfk_2` FOREIGN KEY (`pos_id`) REFERENCES `tbl_pos` (`pos_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_user_ibfk_3` FOREIGN KEY (`dep_id`) REFERENCES `tbl_dep` (`dep_id`);

--
-- Constraints for table `tbl_item`
--
ALTER TABLE `tbl_item`
  ADD CONSTRAINT `tbl_item_ibfk_1` FOREIGN KEY (`usr_id`) REFERENCES `tbl_user` (`usr_id`),
